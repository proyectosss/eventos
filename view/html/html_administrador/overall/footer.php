<footer>
	<div class="footer background-color">
		<br>
		<p class="footer-personalizado">© Copyright 2017 <a href="http://www.pascualbravo.edu.co/" target="_blank" class="footer-personalizado"></a> ®.<br></p>
	</div>
</footer>
<!--Scripts-->
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBvdSbYtHZ_BpzuY7p2PyzqaLemacTDHwU&callback=initMap"async defer></script>
